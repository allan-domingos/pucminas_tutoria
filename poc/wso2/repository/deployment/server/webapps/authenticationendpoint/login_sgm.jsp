...
<html lang="pt" >
<head>
    <link href="sgm/css/bootstrap.min.css" rel="stylesheet" >
    <link href="sgm/font/bootstrap-icons.css" rel="stylesheet" >
     <!-- header -->
	 <%
...
<body onload="checkSessionKey()" class="bg-dark">

	<div class="d-flex justify-content-center" >
		<div class="d-flex flex-column">
			<div class="d-flex flex-row justify-content-center mt-5">
				<img alt="" src="sgm/svg/brasao_imp.svg" width="170px">
			</div>
			<div class="d-flex flex-row justify-content-center mb-5">
				<h1 class="text-white" style="font-family: serif;" >Prefeitura Municipal de Bom Destino</h1>
			</div>
					       ...
					       <!--  <div class="ui container medium center aligned middle aligned"> -->
					        <!--     <div class="ui segment"> -->
								...
								<%
											...
											if (includeBasicAuth) {
												%>
													<%@ include file="custom_basicauth.jsp" %>
												<%
											}
										}
									}
    ...
    <script src="sgm/js/bootstrap.bundle.min.js" ></script>
</body>
</html>
