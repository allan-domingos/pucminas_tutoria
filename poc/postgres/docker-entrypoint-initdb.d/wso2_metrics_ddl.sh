...
GRANT ALL PRIVILEGES ON DATABASE wso2_metrics_db TO wso2carbon;
EOSQL

export PGPASSWORD=wso2carbon

psql -v ON_ERROR_STOP=1 --username "wso2carbon" --dbname "wso2_metrics_db" <<-EOSQL
